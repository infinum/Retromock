...
class MultipleResponseCircular {
  ...
  public interface Service {
    ...
    @MockCircular
    @GET("/")
    Call<MultipleResponseCircular.User> getUser();
  }
  ...
  public static void main(String[] args) throws IOException {
    ...
    MultipleResponseCircular.Service service = retromock.create(MultipleResponseCircular.Service.class);
